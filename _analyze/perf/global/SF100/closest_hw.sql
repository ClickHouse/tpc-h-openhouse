...
(
    ...
    SELECT '01' AS id, 'ClickHouse 236GiB' AS bar_label, 'ClickHouse%' AS system_pat,
           'Enterprise' AS tier, 'default' AS compute_model,
           'aws' AS provider, 'us-east-1' AS region, '236GiB' AS machine, '1' AS cluster_size

    UNION ALL
    SELECT '02' AS id, 'BigQuery' AS bar_label, 'Bigquery' AS system_pat,
    ...
    UNION ALL
    SELECT '03' AS id, 'Redshift' AS bar_label, 'Redshift%' AS system_pat,
    ...
    UNION ALL
    SELECT '05' AS id, 'Snowflake L' AS bar_label, 'Snowflake%' AS system_pat,
           'enterprise' AS tier, NULL AS compute_model,
           'aws' AS provider, 'us-east-1' AS region, 'Gen2 Large' AS machine, '10.8' AS cluster_size


 UNION ALL
    SELECT '09' AS id, 'Databricks XL' AS bar_label, 'Databricks%' AS system_pat,
